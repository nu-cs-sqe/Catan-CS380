...
public class GameTest {
  ...
  public void testPlayersReceiveResourcesFromSecondSettlementOnly() {
    ...
    Assertions.assertEquals(1, p0.getResourceCount(Resource.SHEEP));
    Assertions.assertEquals(1, p0.getResourceCount(Resource.WOOD));

    Player p1 = game.getPlayers().get(1);
    Assertions.assertEquals(1, p1.getResourceCount(Resource.WHEAT));
