...
|-----|---------------------------|--------------------------------------------|--------------|
| TC1 | default construction      | Settlement created, `isCity()` returns false, `getVictoryPoints()` returns 1 | no |
| TC2 | two separate constructions | each instance is independent (not same reference) | no |
...
|     | System under test                    | Expected output | Implemented? |
|-----|--------------------------------------|-----------------|--------------|
| TC3 | freshly constructed Settlement       | false           | no           |
