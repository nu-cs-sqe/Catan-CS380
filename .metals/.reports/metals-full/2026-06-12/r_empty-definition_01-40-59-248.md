error id: file://<WORKSPACE>/src/test/java/domain/TurnFlowTest.java:java/util/List#get().
file://<WORKSPACE>/src/test/java/domain/TurnFlowTest.java
empty definition using pc, found symbol in pc: java/util/List#get().
...
public class TurnFlowTest {
    ...
    public void testPendingCardMovesToHandAfterEndTurn() {
        ...
        turnFlow.buyDevelopmentCard(players.get(0));
        Assertions.assertTrue(
                players.g@@et(0).getDevelopmentCards().isEmpty());
